...
const Contact = () => {
  ...
  return (
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-gray-300 mt-1">
                          <a href="mailto:aneeshx000@mail.com" className="hover:text-blue-400 transition-colors">
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-gray-300 mt-1">Gurugram, India</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        ...
                        <div className="flex space-x-4 mt-3">
                          ...
                          <a
                            href="https://www.linkedin.com/in/aneeshaggarwal/"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-gray-300 hover:text-white transition-colors"
                          >
    ...
    required
                        rows={3}
                        className="w-full px-4 py-3 rounded-lg bg-[#0f172a]/60 border border-gray-700 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        placeholder="Hi Aneesh, I would like to talk about..."
                      ></textarea>
                    </div>
